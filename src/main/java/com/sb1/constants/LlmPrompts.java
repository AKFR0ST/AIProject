...
public final class LlmPrompts {
    ...
    public static final String COVER_LETTER_TEMPLATE = """
            ...
            Первое предложение: "Добрый день!". Далее 1–2 предложения, прямо к делу, с акцентом на совпадение навыков и опыта.
    ...
    public static final String SCORE_TEMPLATE = """
            ...
            Если отсутствуют ключевые обязательные требования — итоговая оценка не может быть выше 60.
            Не придумывай недостающий опыт.
            Не завышай оценку без объективных оснований.
            
            Инструкция по ответу:
            
            1. Рассчитай итоговую оценку (целое число от 0 до 100).
            2. Округляй до целого числа.
            3. Верни ТОЛЬКО число, без текста, без пояснений, без символов.
